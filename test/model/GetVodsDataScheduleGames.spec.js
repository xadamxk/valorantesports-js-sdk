...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetVodsDataScheduleGames', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetVodsDataScheduleGames();
      });

      it('should create an instance of GetVodsDataScheduleGames', function() {
        // TODO: update the code to test GetVodsDataScheduleGames
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetVodsDataScheduleGames);
      });
