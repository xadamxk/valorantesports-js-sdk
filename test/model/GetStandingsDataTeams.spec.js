...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStandingsDataTeams', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetStandingsDataTeams();
      });

      it('should create an instance of GetStandingsDataTeams', function() {
        // TODO: update the code to test GetStandingsDataTeams
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetStandingsDataTeams);
      });
