...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLeaguesForStandingsDataLeagues', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLeaguesForStandingsDataLeagues();
      });

      it('should create an instance of GetLeaguesForStandingsDataLeagues', function() {
        // TODO: update the code to test GetLeaguesForStandingsDataLeagues
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLeaguesForStandingsDataLeagues);
      });
