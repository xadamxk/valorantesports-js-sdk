...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetEventDetailsDataEventMatchResult', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetEventDetailsDataEventMatchResult();
      });

      it('should create an instance of GetEventDetailsDataEventMatchResult', function() {
        // TODO: update the code to test GetEventDetailsDataEventMatchResult
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetEventDetailsDataEventMatchResult);
      });
