...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetVodsData', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetVodsData();
      });

      it('should create an instance of GetVodsData', function() {
        // TODO: update the code to test GetVodsData
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetVodsData);
      });
