...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStandings', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetStandings();
      });

      it('should create an instance of GetStandings', function() {
        // TODO: update the code to test GetStandings
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetStandings);
      });
