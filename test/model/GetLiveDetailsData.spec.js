...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLiveDetailsData', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLiveDetailsData();
      });

      it('should create an instance of GetLiveDetailsData', function() {
        // TODO: update the code to test GetLiveDetailsData
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLiveDetailsData);
      });
