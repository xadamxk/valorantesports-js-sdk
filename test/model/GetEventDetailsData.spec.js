...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetEventDetailsData', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetEventDetailsData();
      });

      it('should create an instance of GetEventDetailsData', function() {
        // TODO: update the code to test GetEventDetailsData
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetEventDetailsData);
      });
