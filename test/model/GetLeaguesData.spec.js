...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLeaguesData', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLeaguesData();
      });

      it('should create an instance of GetLeaguesData', function() {
        // TODO: update the code to test GetLeaguesData
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLeaguesData);
      });
