...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStandingsDataCells', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetStandingsDataCells();
      });

      it('should create an instance of GetStandingsDataCells', function() {
        // TODO: update the code to test GetStandingsDataCells
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetStandingsDataCells);
      });
