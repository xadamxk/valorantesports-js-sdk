...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetEventListDataInProgress', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetEventListDataInProgress();
      });

      it('should create an instance of GetEventListDataInProgress', function() {
        // TODO: update the code to test GetEventListDataInProgress
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetEventListDataInProgress);
      });
