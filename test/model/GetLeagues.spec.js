...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLeagues', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLeagues();
      });

      it('should create an instance of GetLeagues', function() {
        // TODO: update the code to test GetLeagues
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLeagues);
      });
