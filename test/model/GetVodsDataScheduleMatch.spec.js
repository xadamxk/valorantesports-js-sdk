...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetVodsDataScheduleMatch', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetVodsDataScheduleMatch();
      });

      it('should create an instance of GetVodsDataScheduleMatch', function() {
        // TODO: update the code to test GetVodsDataScheduleMatch
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetVodsDataScheduleMatch);
      });
