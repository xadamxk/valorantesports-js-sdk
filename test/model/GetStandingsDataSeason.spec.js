...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStandingsDataSeason', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetStandingsDataSeason();
      });

      it('should create an instance of GetStandingsDataSeason', function() {
        // TODO: update the code to test GetStandingsDataSeason
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetStandingsDataSeason);
      });
