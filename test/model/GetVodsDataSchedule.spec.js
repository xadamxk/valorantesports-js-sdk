...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetVodsDataSchedule', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetVodsDataSchedule();
      });

      it('should create an instance of GetVodsDataSchedule', function() {
        // TODO: update the code to test GetVodsDataSchedule
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetVodsDataSchedule);
      });
