...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStandingsData', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetStandingsData();
      });

      it('should create an instance of GetStandingsData', function() {
        // TODO: update the code to test GetStandingsData
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetStandingsData);
      });
