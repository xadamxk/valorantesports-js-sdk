...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetEventList', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetEventList();
      });

      it('should create an instance of GetEventList', function() {
        // TODO: update the code to test GetEventList
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetEventList);
      });
