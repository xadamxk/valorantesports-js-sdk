...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLeaguesForStandingsDataSeason', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLeaguesForStandingsDataSeason();
      });

      it('should create an instance of GetLeaguesForStandingsDataSeason', function() {
        // TODO: update the code to test GetLeaguesForStandingsDataSeason
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLeaguesForStandingsDataSeason);
      });
