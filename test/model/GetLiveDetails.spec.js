...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLiveDetails', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLiveDetails();
      });

      it('should create an instance of GetLiveDetails', function() {
        // TODO: update the code to test GetLiveDetails
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLiveDetails);
      });
