...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetVodsDataScheduleLeague', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetVodsDataScheduleLeague();
      });

      it('should create an instance of GetVodsDataScheduleLeague', function() {
        // TODO: update the code to test GetVodsDataScheduleLeague
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetVodsDataScheduleLeague);
      });
