...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStandingsDataColumns', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetStandingsDataColumns();
      });

      it('should create an instance of GetStandingsDataColumns', function() {
        // TODO: update the code to test GetStandingsDataColumns
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetStandingsDataColumns);
      });
