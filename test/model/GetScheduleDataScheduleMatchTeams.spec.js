...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetScheduleDataScheduleMatchTeams', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetScheduleDataScheduleMatchTeams();
      });

      it('should create an instance of GetScheduleDataScheduleMatchTeams', function() {
        // TODO: update the code to test GetScheduleDataScheduleMatchTeams
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetScheduleDataScheduleMatchTeams);
      });
