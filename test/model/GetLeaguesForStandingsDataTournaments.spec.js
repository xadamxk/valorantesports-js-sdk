...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetLeaguesForStandingsDataTournaments', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetLeaguesForStandingsDataTournaments();
      });

      it('should create an instance of GetLeaguesForStandingsDataTournaments', function() {
        // TODO: update the code to test GetLeaguesForStandingsDataTournaments
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetLeaguesForStandingsDataTournaments);
      });
