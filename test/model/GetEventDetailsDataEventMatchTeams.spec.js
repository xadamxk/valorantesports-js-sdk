...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetEventDetailsDataEventMatchTeams', function() {
      beforeEach(function() {
        instance = new ValorantEsportsOpenApiSpecification.GetEventDetailsDataEventMatchTeams();
      });

      it('should create an instance of GetEventDetailsDataEventMatchTeams', function() {
        // TODO: update the code to test GetEventDetailsDataEventMatchTeams
        expect(instance).to.be.a(ValorantEsportsOpenApiSpecification.GetEventDetailsDataEventMatchTeams);
      });
